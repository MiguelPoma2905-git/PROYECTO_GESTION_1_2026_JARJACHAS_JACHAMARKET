...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($roles_seleccionados)) {
        ...
        $_SESSION['registro_temp']['roles_seleccionados'] = $roles_seleccionados;
        $_SESSION['registro_temp']['avatar'] = $avatar_seleccionado;
...
$stmt->execute();
$roles_disponibles = $stmt->fetchAll();

// Lista de avatares predeterminados
$avatares_default = [];
for ($i = 1; $i <= 8; $i++) {
    $avatares_default[] = "assets/avatars/default/avatar_{$i}.png";
}
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    ...
    <div class="roles-container">
        ...
        <form method="POST" id="registroRolesForm">
            <div class="two-columns">
                ...
                <div class="roles-section">
                    ...
                    <div class="roles-grid">
                        <div class="rol-card" data-rol="Cliente">
                            <div class="rol-image"><img src="assets/images/rol_1.png" alt="Cliente" class="rol-img"></div>
                            <div class="rol-info">
                                <h4>Cliente</h4>
                        ...
                        <div class="rol-card" data-rol="Emprendedor">
                            <div class="rol-image"><img src="assets/images/rol_2.png" alt="Emprendedor" class="rol-img"></div>
                            <div class="rol-info">
                                <h4>Emprendedor</h4>
                        ...
                        <div class="rol-card" data-rol="Repartidor">
                            <div class="rol-image"><img src="assets/images/rol_3.png" alt="Repartidor" class="rol-img"></div>
                            <div class="rol-info">
                                <h4>Repartidor</h4>
                ...
                <div class="avatar-section">
                    ...
                    <div class="avatar-preview" id="avatarPreview">
                        <img src="assets/avatars/default/avatar_1.png" alt="Avatar">
                    </div>
                    
                    <div class="avatar-grid" id="avatarGrid">
                        <?php foreach ($avatares_default as $index => $avatar): ?>
                        <div class="avatar-option" data-avatar="<?php echo $avatar; ?>" data-index="<?php echo $index; ?>">
                            <img src="<?php echo $avatar; ?>" alt="Avatar <?php echo $index+1; ?>">
                        </div>
                        <?php endforeach; ?>
                    </div>
    ...
    <script>
        ...
        // Subir imagen personalizada - Guardar temporalmente
        ...
        fileInput.addEventListener('change', async (e) => {
            ...
            if (file) {
                // Mostrar preview localmente mientras se sube
                ...
                try {
                    ...
                    const response = await fetch('guardar_temp_avatar.php', {
                        method: 'POST',
                        body: formData
                    });
                    ...
                    if (result.success) {
                        // Actualizar preview y guardar ruta en el input oculto
                        avatarInput.value = result.temp_url;
                        
                        // Marcar que es una imagen personalizada
                        avatarOptions.forEach(opt => opt.classList.remove('selected'));

...
-- ==============================
-- 10b. SUCURSALES (NUEVO: faltaban en Top_1.sql)
-- ==============================
...
INSERT INTO sucursales (id_emprendimiento, nombre_sucursal, direccion, ciudad) VALUES
(@id_tecnostore, 'Sucursal Central', 'Av. 16 de Julio #500, Edificio Urus', 'La Paz'),
(@id_artesanias, 'Tienda Principal', 'Calle Santivañez #234', 'Cochabamba');

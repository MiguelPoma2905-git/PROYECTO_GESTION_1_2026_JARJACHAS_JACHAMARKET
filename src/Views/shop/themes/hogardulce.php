...
<?php elseif ($themePart === 'html'): ?>
        ...
        <div class="t12-grid">
            ...
            <div class="t12-card" data-id="<?= $producto['id_producto'] ?>" data-nombre="<?= htmlspecialchars($producto['nombre'], ENT_QUOTES) ?>" data-precio="<?= $producto['precio_base'] ?>" data-stock="<?= $producto['stock'] ?>">
                ...
                <div class="t12-card-body">
                    ...
                    <div class="t12-desc"><?= htmlspecialchars(substr($producto['descripcion'], 0, 80)) ?></div>
                    <?php endif; ?>
                    <?php if ($atributos): ?>
                    <div class="t12-tags">
    ...
    function renderCarrito() {
        ...
        carrito.forEach((item, idx) => {
            ...
            html += '<div class="t12-cart-item"><div class="t12-cart-item-img"><img src="' + BASE + '/' + (item.img || 'assets/images/placeholder_producto.jpg') + '" onerror="this.src=\'' + BASE + '/assets/images/placeholder_producto.jpg\'"></div><div class="t12-cart-item-info"><h4>' + item.nombre + '</h4><div class="p">Bs. ' + parseFloat(item.precio).toFixed(2) + '</div><div class="t12-cart-qty"><button onclick="cambiarCantidad(' + idx + ',-1)">-</button><span>' + item.cantidad + '</span><button onclick="cambiarCantidad(' + idx + ',1)">+</button></div></div><button class="t12-cart-item-del" onclick="eliminarDelCarrito(' + idx + ')"><i class="fas fa-trash-alt"></i></button></div>';
        });
        body.innerHTML = html;

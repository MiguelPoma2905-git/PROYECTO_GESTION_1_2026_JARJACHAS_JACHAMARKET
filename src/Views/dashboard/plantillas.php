...
<body>
    <div class="container">
        ...
        <p class="subtitle">Elige una plantilla y ajusta los colores para <?= htmlspecialchars($emprendimiento['nombre_comercial']) ?></p>
        ...
        <div class="editor-container">
            <div class="preview-area" id="previewArea" 
                 style="--preview-primary: <?= $personalizacion['color_primario'] ?? '#fa7136' ?>; 
                        --preview-secondary: <?= $personalizacion['color_secundario'] ?? '#1a4147' ?>;
                        --preview-bg: <?= $personalizacion['color_fondo'] ?? '#ffffff' ?>">
            ...
            <div class="controls-area">
                ...
                <div class="plantilla-selector">
                    ...
                    <div class="plantilla-option <?= $personalizacion['id_plantilla'] == $plantilla['id_plantilla'] ? 'selected' : '' ?>" 
                        ...
                        <div class="color-preview">
                            <div class="color-dot" style="background: <?= $plantilla['color_primario'] ?>;"></div>
                            <div class="color-dot" style="background: <?= $plantilla['color_secundario'] ?>;"></div>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
                
                <form method="POST" action="<?= BASE_URL ?>/plantillas?id_emprendimiento=<?= $emprendimiento['id_emprendimiento'] ?>">
                    <input type="hidden" name="id_plantilla" id="id_plantilla" value="<?= $personalizacion['id_plantilla'] ?>">
                    <div class="form-group">
                        <label>Color principal</label>
                        <input type="color" name="color_primario" id="color_primario" value="<?= $personalizacion['color_primario'] ?? '#fa7136' ?>">
                    </div>
                    <div class="form-group">
                        <label>Color secundario</label>
                        <input type="color" name="color_secundario" id="color_secundario" value="<?= $personalizacion['color_secundario'] ?? '#1a4147' ?>">
                    </div>
                    <div class="form-group">

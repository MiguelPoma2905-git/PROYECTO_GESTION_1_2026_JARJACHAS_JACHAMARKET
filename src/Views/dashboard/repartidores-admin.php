...
<body class="dashboard-body">
    ...
    <div class="main-content">
        ...
        <div class="dash-container">
            ...
            <?php else: ?>
                <div style="text-align:center; padding:80px 20px; background:var(--card-bg); border:1px solid var(--border); border-radius:4px;">
                    <i class="fas fa-users" style="font-size:36px; opacity:0.2; color:var(--text-muted); margin-bottom:12px; display:block;"></i>
                    <p style="font-size:13px; color:var(--text-muted)">Selecciona uno de tus negocios para gestionar sus repartidores.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>

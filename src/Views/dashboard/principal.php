...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <?php endif; ?>
            <a href="<?= BASE_URL ?>/perfil">Configuración</a>
    ...
    <div class="main-content">
        <div class="top-bar">
            ...
            <div class="user-dropdown" id="userDropdown">
                ...
                <div class="dropdown-menu">
                    <a href="<?= BASE_URL ?>/perfil" class="dropdown-item">⚙️ Configuración</a>
        ...
        <div class="container">
            ...
            <div class="welcome-section">
                ...
                <p>Estás viendo el panel como <strong><?= $rol_activo ?></strong></p>
            </div>
                        ...
                        <div class="negocio-card" onclick="window.location.href='<?= BASE_URL ?>/tienda/<?= $negocio['id_emprendimiento'] ?>'">
                            <div class="negocio-preview">
                                <div class="negocio-colors">
                                    <div class="negocio-color" style="background: <?= $negocio['color_primario'] ?: '#ffffff' ?>;"></div>
                                    <div class="negocio-color" style="background: <?= $negocio['color_secundario'] ?: '#888888' ?>;"></div>
                                </div>
                            </div>
                            <div class="negocio-info">
                                <h3><?= htmlspecialchars($negocio['nombre_comercial']) ?></h3>
                                <p><?= htmlspecialchars(substr($negocio['descripcion'] ?? '', 0, 60)) ?>...</p>
                                <span class="negocio-tag">📦 <?= $negocio['total_productos'] ?> productos</span>
                                <span class="negocio-tag">🎨 <?= $negocio['plantilla_nombre'] ?? 'Moderno' ?></span>
                                <a href="<?= BASE_URL ?>/productos?id_emprendimiento=<?= $negocio['id_emprendimiento'] ?>" class="btn-visitar">Administrar tienda</a>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    <?php else: ?>

<div class="preview-device" id="previewDevice"
     style="--preview-primary: <?= $personalizacion['color_primario'] ?? '#C0392B' ?>;
            --preview-secondary: <?= $personalizacion['color_secundario'] ?? '#2C3E50' ?>;
            --preview-bg: <?= $personalizacion['color_fondo'] ?? '#FDFBF7' ?>;
            --preview-text: <?= $personalizacion['color_texto'] ?? '#1A1A2E' ?>;
            --preview-glow: rgba(192,57,43,0.06);
            --preview-glow2: rgba(44,62,80,0.04);
